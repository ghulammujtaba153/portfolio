  ...
  return (
    ...
    >
      ...
      <h1 className="mb-10 mt-4 px-4 text-2xl sm:text-4xl">
        <span className="font-medium !leading-[1.5] ">Crafting innovative and efficient software solutions.</span>{" "}
        <p className="text-[14px]">
        I am a dedicated Software Engineer with expertise in designing, developing, and optimizing web applications. My work emphasizes clean architecture, scalability, and delivering exceptional user experiences.
        </p>
      </h1>
      </Fade>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/ghulam-mujtaba-a35749243/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/ghulammujtaba153"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
